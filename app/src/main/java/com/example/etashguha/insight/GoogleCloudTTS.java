...
public class GoogleCloudTTS {
    ...
    public GoogleCloudTTS(String text){
        this.text = text;
    }
...
//            mediaPlayer.start();
    ...
    public void process(){
        //playAudioFromString(executePost(text));
       set64String (executePost(text));
    }
    public String set64String(String base64tring){
            return executePost(base64tring);
    }
    public String get64String(){
        return executePost(text);
    }
